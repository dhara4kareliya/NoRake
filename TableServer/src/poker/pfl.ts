export class GameTable {
    public static MAX_TABLE_SIZE: number;
    public _table: Array<Sit> = new Array<Sit>();
    constructor(max_table_size?: number) {
        GameTable.MAX_TABLE_SIZE = max_table_size || 9;
        for (
...
export class PFLogic {
    ...
    constructor(numberOfSeats?: number) {
        this._gameTable = new GameTable(numberOfSeats);
    }
